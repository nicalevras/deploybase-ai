...
| Best API model | Sonar Pro: $3/$10 | Sonnet 4.6: $3/$15 | Sonar Pro |
...
**Sonar Pro** ($3.00 input / $10.00 output per 1M tokens)
...
Perplexity Sonar Pro: (5K × $3 + 2K × $10) / 1M = **$0.035**
Claude Sonnet: (5K × $3 + 2K × $15) / 1M = **$0.045**

Sonnet slightly cheaper. But Sonar Pro includes real-time search; Sonnet does not.
...
Perplexity Sonar Pro: (100M × $3 + 100M × $10) / 1M = **$13,000/month**
Claude Sonnet: (100M × $3 + 100M × $15) / 1M = **$18,000/month**

Perplexity is 27% cheaper at scale on per-token rates.

But add search: 1,000 searches/month × $2 = $2,000 extra.
Perplexity total: $13,000 + $2,000 = **$15,000/month**

For pure reasoning without search, Claude is cheaper. For search + reasoning, Perplexity becomes expensive.
