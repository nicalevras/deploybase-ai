...
RTX 4090s deliver roughly 82.6 TFLOPS (FP32) or ~1,321 TOPS (INT8 tensor). An A100 hits 19.5 TFLOPS FP32. H100s reach 60 TFLOPS FP32 or ~3,958 TOPS INT8 tensor. These numbers dwarf CPU performance.
