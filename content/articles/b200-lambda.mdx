...
- **Compute**: ~9 PFLOPS FP8, ~180 TFLOPS FP32, Transformer Engine 2.0
...
Understanding B200's improvements provides context. H100 infrastructure represents the previous-generation standard. H100 delivers 141 TFLOPS; B200 delivers approximately 2.6x higher throughput. This translates to 2-2.5x faster training and inference compared to equivalent H100 setups.
...
- [Lambda Labs GPU Cloud Platform](https://lambdalabs.com) (external)
