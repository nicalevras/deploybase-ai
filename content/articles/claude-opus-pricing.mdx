...
All Opus variants (4.6, 4.5, 4.1, 4): $5 per million input, $25 per million output. Pricing parity means cost-neutral model comparisons.
...
Pricing is identical ($5/$25), making it irrational to use vs 4.5 or 4.6. Only legacy systems justify it.

Teams using 4.1? Upgrade to 4.5. Free upgrade on cost, quality improvement everywhere.

## Opus 4: Original Generation

First Opus-class model (2024). Capable but lags on reasoning and code.

Pricing identical ($5/$25). Economically dominated by newer variants.

Only legacy systems justify it. Migrate to 4.5. Same cost, better quality.
