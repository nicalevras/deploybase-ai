...
|--------|------------|--------|
| **Model** | Claude Sonnet 4.6 API | GPT-4.1 / Claude 3.5 Sonnet (selectable) |
...
| **Model Choice** | Claude Sonnet 4.6 only | Claude 3.5 Sonnet or GPT-4.1 |
...
Claude Code uses Claude Sonnet 4.6 (Anthropic's API). Cursor can use Claude 3.5 Sonnet or GPT-4.1 (user's choice in settings). If team prefers GPT-4.1, Cursor is the only option. If team is standardized on Anthropic, Claude Code is the only option.
