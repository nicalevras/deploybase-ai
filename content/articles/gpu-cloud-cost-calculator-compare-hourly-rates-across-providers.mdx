...
RunPod H100 SXM rate: $2.69/hour
Monthly compute cost: 720 x $2.69 = $1,937

Storage adds a monthly component:

Storage size: 100GB
RunPod storage rate: $0.01/GB/month
Monthly storage: 100 x $0.01 = $1

Data transfer multiplies with usage:

Outbound traffic: 500GB monthly
Egress rate: $0.12/GB
Monthly egress: 500 x $0.12 = $60
...
On-demand H100 SXM (RunPod): $2.69/hour
1-year reserved: ~28% discount = ~$1.94/hour
3-year reserved: ~40% discount = ~$1.61/hour
