...
- H100 SXM (96GB VRAM): $2.49/hour Lambda, $2.69/hour RunPod
  - Handles Llama 4 with batch size 256
  - Achieves 3,000-3,200 tokens/second
  - Cost-per-token: $0.000375

- A100 40GB: $1.19/hour RunPod, $1.25/hour Vast.AI
  - Handles Llama 4 with batch size 128-160
  - Achieves 1,200-1,600 tokens/second
  - Cost-per-token: $0.000198
