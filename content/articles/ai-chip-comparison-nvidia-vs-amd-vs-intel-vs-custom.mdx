...
**H100 SXM**: $2.69-3.78/hr cloud rental. 80GB HBM3. 989 TFLOPS FP16 tensor (3,958 TFLOPS FP8 tensor). Standard for training. Every major LLM trained on these.
...
**L40S**: $0.79/hr. Hopper architecture, inference optimized. Good for serving models.
...
**MI300X**: $1.50-2.50/hr cloud. 192GB HBM3E. Similar performance to H100 on training. Cheaper.
