...
Benchmark: 96% on AIME (math), 97% on MATH Olympiad. Outperforms GPT-4.1 on pure reasoning tasks.
...
Llama 3 (1M context), Mistral 7B (32K), DeepSeek R1 (256K). Check Ollama model cards for exact context windows.
