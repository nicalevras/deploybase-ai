...
- g5.xlarge: 1 × NVIDIA L40 GPU, $1.006/hour
- g5.24xlarge: 6 × NVIDIA L40 GPUs, $6.036/hour
...
Standard_NCadsH100_v5 (latest):
- 8 × NVIDIA H100 GPUs, $28.60/hour
...
AWS is ~15% cheaper on older generation hardware. However, Azure's newer H100 instances cost $28.60/hour (compared to AWS's p3dn.24xlarge at $24.48), but newer architecture offers better performance per GPU.

If comparing latest-generation GPUs:

| Instance | GPUs | Architecture | Hourly Cost |
|----------|------|------------|------------|
| AWS p4d.24xlarge | 8 | NVIDIA H100 | $32.77 |
| Azure Standard_ND96asr_H100_v5 | 8 | NVIDIA H100 | $32.88 |
