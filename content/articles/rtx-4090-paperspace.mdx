...
RTX 4090 suits inference workloads for 7B-13B models comfortably. Larger 70B models squeeze into 24GB but require quantization or careful memory management. The 576 TFLOPS peak compute is adequate for batch inference but weak for large-scale training.
