...
B200: 192GB HBM3e (2.4x), 1,456 TFLOPS (FP8), 8TB/s bandwidth (4x). Spec wins go to B200. But specs don't tell the whole story on inference, where bandwidth and latency matter more.
...
The H100 and H200 occupy the middle ground. H200 offers better inference performance than H100, costing roughly 2x an A100 ($2.69 vs $1.39 on RunPod). B200 at 3x offers diminishing returns versus H200 for most inference workloads. Run benchmarks with your specific models.
