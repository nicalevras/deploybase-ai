...
- H100 cost (RunPod): $2.49/hr × 2.2 = $5.48

**SGLang at 16,215 tok/s:**
- Time to process: 100M ÷ 16,215 = 6,168 seconds = 1.7 hours
- H100 cost: $2.49/hr × 1.7 = $4.23

Cost difference: $1.25 per 100M tokens. Over a year (36.5B tokens): ~$456 saved on compute alone.
...
At 1,000 requests/day, vLLM serves 600K tokens/day on one H100. SGLang serves 800K tokens/day (same H100). At scale (100K requests/day), SGLang saves one full H100 ($2.49/hr × 24 = $59.76/day = $21,812/year).
