...
**p4d.24xlarge:** Eight A100s (40GB each). $32.77/hour. Production-scale inference. [CoreWeave's 8xA100: $21.60/hour](/articles/coreweave-gpu-pricing):cheaper for sustained workloads.
...
python -m vllm.entrypoints.openai.api_server \
  --model meta-llama/Llama-3-13b-hf \
...
curl http://localhost:8000/v1/completions \
  ...
  -d '{"model": "meta-llama/Llama-3-13b-hf", "prompt": "Write Python", "max_tokens": 100}'
```
...
```
curl http://localhost:11434/api/generate -d '{"model": "llama3:13b", "prompt": "Write Python", "stream": false}'
```
...
AWS for sustained inference runs pricey. p4d.24xlarge $32.77/hour = $23.7K/month. Specialize GPU clouds beat it.
