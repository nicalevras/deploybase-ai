...
**NVIDIA H100 Series (80GB HBM3)**: Standard pricing tier for large language models and diffusion models. Per-hour rates range from $2.50-$4.20 depending on region and commitment. H100s deliver 1979 FP32 TFLOPS and 7918 TFLOPS in sparsity-enabled configurations, making them ideal for dense transformer workloads.
...
Comparing [RunPod GPU pricing](/articles/runpod-gpu-pricing) reveals H100 SXM at $2.69/hour, which provides a useful baseline for evaluating Crusoe's competitive positioning. RunPod's rates suggest Crusoe likely prices H100 instances in the $3.20-$3.80/hour range.
...
- Hourly rate: $3.50 (estimated Crusoe pricing)
...
- [Lambda GPU pricing](/articles/lambda-labs-gpu-pricing) offers H100 SXM at $2.49/hour ($1,797/month, $21,562/year)
...
Crusoe's estimated H100 rate of $3.50/hour is higher than Lambda's $2.49/hour H100 SXM rate. Teams focused on H100 workloads should compare carefully. Compared to AWS, Crusoe savings reach 20-30% depending on region and instance type.

### Multi-GPU Cluster Economics

Training teams commonly deploy 4-8 GPU clusters. Crusoe's per-GPU rates scale efficiently:

4×H100 cluster: 4 × $3.50 = $14/hour
- Monthly cost: $10,080
- Annual cost: $120,960

8×H100 cluster: 8 × $3.50 = $28/hour
- Monthly cost: $20,160
- Annual cost: $241,920

Comparing [CoreWeave GPU pricing](/articles/coreweave-gpu-pricing) at $49.24/hour for 8×H100, Crusoe costs $28/hour, representing 43% cost reduction. However, CoreWeave's rates include optimized networking and pre-configured multi-GPU support, potentially reducing engineering overhead.
...
- Cost at Crusoe: 4.17 × $3.50 = $14.60
...
- Current on-demand: $3.50/hour
- Reserved rate: $2.80/hour
- Break-even: 6,857 hours or approximately 8.5 months

For workloads with 12-month commitment certainty, reserved pricing would generate $840 annual savings on single H100. Multi-GPU clusters would realize proportional savings scaling to thousands annually.
...
|---|---|---|---|---|
| Single H100 | $3.50 | $2,520 | $30,240 | Small model training, large model inference |
| 2×H100 Cluster | $7.00 | $5,040 | $60,480 | Distributed 7B training, ensemble inference |
| 4×H100 Cluster | $14.00 | $10,080 | $120,960 | 34B model training, high-throughput inference |
| 8×H100 Cluster | $28.00 | $20,160 | $241,920 | 70B model training, production inference |
...
|---|---|---|---|---|
| Single A100 40GB | $2.10 | $1,512 | $18,144 | Llama 2 7B inference batch 8 |
| Single A100 80GB | $2.45 | $1,764 | $21,168 | Llama 2 13B inference batch 8 |
| 2×A100 80GB | $4.90 | $3,528 | $42,336 | Llama 2 13B distributed training |
| 4×A100 80GB | $9.80 | $7,056 | $84,672 | Llama 2 34B distributed training |
...
- Lower than: AWS ($4.20/hour), Azure ($4.20/hour)
- Comparable to: Lambda ($2.49/hour H100 SXM)
- Equivalent to: Nebius ($3.20-3.45/hour)
- Higher than: RunPod ($2.69/hour)
