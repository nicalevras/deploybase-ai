---
title: 'AMD MI325X Pricing Guide: 288GB HBM3e Memory & Availability'
slug: amd-mi325x-price
description: >-
  AMD MI325X price expectations $5-8/hr. Specifications, 288GB memory advantage,
...
AMD MI325X, announced in late 2024 with availability beginning Q1 2025, features 288GB HBM3e memory (3x MI300X capacity) at estimated $5-8 per GPU-hour. The GPU targets ultra-large model deployment and long-context inference where memory capacity is the primary bottleneck.
...
**AMD MI325X:**
- Memory: 288GB HBM3e (192GB MI300X, 80GB H100)
- Compute: 91.1 TFLOPS FP32 (similar to MI300X)
...
**Memory Positioning:**
288GB enables single-GPU deployment of:
- 405B parameter models in FP16 (810GB required, 3xMI325X)
- 140B parameter models in FP16 (280GB)
...
Pricing for MI325X is not officially published as of March 2025. AMD typically prices 20-30% above previous generation. MI300X cloud pricing is $3-4/hour, suggesting MI325X at $4-5/hour.

**Expected Pricing Scenarios:**

| Scenario | Price/hr | Justification |
|----------|----------|---------------|
| Conservative (20% premium) | $4.50-5.00 | Match MI300X ratio |
| Aggressive (40% premium) | $5.50-6.50 | Memory premium |
| Neutral (30% premium) | $5.00-6.00 | Standard refresh pricing |
| Premium (50%+) | $6.00-8.00 | Limited supply markup |

Industry consensus: $5-7/hour for MI325X on-demand pricing once available through major providers.

**Comparison to NVIDIA B200:**
- NVIDIA B200 estimated: $12-15/hour
- AMD MI325X estimated: $5-7/hour
- AMD advantage: 2-3x cheaper for similar memory capacity

If AMD prices MI325X below $8/hour, it will dominate memory-constrained inference markets despite lower compute.
...
|--------|--------|--------|------------|
| Memory | 192GB HBM3e | 288GB HBM3e | 1.5x |
| Compute | 91.1 TFLOPS | 91.1 TFLOPS | Same |
| Bandwidth | 5.3TB/s | 5.3TB/s | Same |
| Power | 700W | 700W | Same |
| Architecture | TSMC 5nm | TSMC 5nm | Same |

MI325X is essentially MI300X with 50% more memory at same compute. Value proposition: enables larger models on single GPU.

**Use Case Advantage:**
- Models fitting in 192GB: No advantage (MI300X adequate)
- Models 192-288GB: MI325X required
- Models 288GB+: MI325X still insufficient (cluster required)

MI325X targets the "awkward middle" where a single MI300X doesn't fit but MI325X does.

**Upgrade Path:**
Current MI300X customers can upgrade to MI325X for 1.5x model capacity without increasing cluster size. Costs increase 20-30% for 50% memory gain (economical for memory-bound workloads).
...
H200 costs 50% of MI325X but has 50% memory. For models 80-141GB, H200 wins on cost. For models 140-288GB, MI325X is required.
...
- Memory: MI325X 3x larger (288GB vs 96GB)
...
- Memory: MI325X 2x larger (288GB vs 141GB)
- Cost: MI325X 50% more expensive ($6-7 vs $3-4/hr)
- Use case: H200 optimal for 80-140GB models, MI325X for 140-288GB

For 200B models: Tie (1xMI325X = $6/hr vs 2xH200 = $6-8/hr)

**AMD MI300X vs MI325X:**
- Compute: Identical (91 TFLOPS)
- Memory: MI325X 50% more (288GB vs 192GB)
- Cost: MI325X 30-40% premium ($6-7 vs $3-4/hr)
- Use case: MI300X sufficient for 70-192GB; MI325X for 192-288GB
...
**Cooling:**
700W thermal envelope is same as H100, but MI325X's memory density (288GB in same physical space) may require tighter cooling tolerances. Validate data center cooling before deployment.
