...
CoreWeave raised $110M Series B, focusing on vertical integration across hardware, software, and managed services. The platform matured significantly by 2026.
...
CoreWeave: $0.95/hour for single H100 (80GB). Discount available for reserved instances (1-year: 35% discount; 3-year: 50% discount). Spot instances: 50-70% discount, but preemption risk.

Crusoe: $0.89/hour for single H100. 1-year reserved: 40% discount. 3-year reserved: 55% discount. Spot instances: 60-75% discount.

Reserved instance calculations (1-year):
- CoreWeave: $0.95 * 0.65 (35% discount) * 8760 hours = $5,408/year
- Crusoe: $0.89 * 0.60 (40% discount) * 8760 hours = $4,678/year

Crusoe's cost advantage: $730/year per H100, compounding across large clusters.
