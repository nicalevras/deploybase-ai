...
CoreWeave specializes in high-performance computing workloads. H100 pricing ($3.10/hour standard) undercuts AWS but exceeds RunPod for non-spot instances. H200s run $4.05/hour. Their strength: instant scaling for large batch jobs and integrated high-speed networking. Committed customer deals reduce pricing 15-25% for guaranteed monthly spend minimums.
...
RunPod standard: $1,936 (GPU) + $200 (storage/network) = $2,136
Lambda: $2,724 (GPU) + $200 (storage) = $2,924
AWS on-demand: $4,680 (GPU) + $500 (storage/bandwidth) = $5,180
AWS reserved (1-year): $3,024 (GPU) + $500 (storage) = $3,524
CoreWeave: $2,232 (GPU) + $300 (storage) = $2,532
