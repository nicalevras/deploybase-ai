...
**A10**: Lambda's other option for inference workloads. Delivers 24GB GDDR6 memory at approximately $0.86 per hour. A10 tensor compute (312 TFLOPS FP32) trails RTX 3090 (358 TFLOPS FP32) by roughly 13%, though professional drivers may recover some performance differential through optimization.
...
- 24GB GDDR6 memory
- ~358-360 TFLOPS FP32 peak compute
...
- **Compute**: 358 TFLOPS FP32 peak compute, 1,432 TFLOPS with tensor operations
- **Memory Bandwidth**: 576 GB/s (modest for memory-bound inference)
