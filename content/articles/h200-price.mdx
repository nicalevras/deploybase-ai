...
slug: h200-price
description: >-
  NVIDIA H200 cloud pricing: $3.59/hour on RunPod, $6.50 on CoreWeave. Rental
...
H200 Price is the focus of this guide. RunPod: $3.59/hr. CoreWeave: $6.50/hr (single), $50.44/hr (8-GPU cluster). 141GB HBM3e (vs H100's 80GB). Premium reflects extra memory and bandwidth. Worth it for large models and long-context. H100 better value for smaller workloads.
...
| Lambda | GH200 (96GB) | 96GB | Custom | $1.99 | $1,453 |
| CoreWeave | NVIDIA H200 (single) | 141GB | SXM | $6.50 | $4,745 |
...
$6.50/hr single GPU, $50.44/hr for 8-GPU cluster. Purpose-built for multi-GPU ML workloads. Cluster form factor provides NVLink interconnect (essential for distributed training). Higher per-GPU rate but economy of scale at 8+ GPUs.
...
Offers GH200 (96GB, a different SKU) at $1.99/hr but not native H200. GH200 is a dual-GPU module (limited availability in cloud). Most teams prefer RunPod for H200 availability.
