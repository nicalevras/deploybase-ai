...
Function calling (OpenAI) has no security model. Teams are responsible for all safety checks.

### Problem 4: Portability

If teams build on OpenAI's function calling, they are locked into OpenAI. Switch to Claude? Rebuild everything. Switch to local Llama? Rebuild again.
