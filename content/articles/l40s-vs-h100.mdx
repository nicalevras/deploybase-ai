...
GPU Memory: 48GB GDDR6 (memory bandwidth: 864 GB/s)
Tensor Performance: 91.6 TFLOPS FP32, 366 TFLOPS TF32 (with sparsity: 733 TFLOPS), 733 TFLOPS FP16 (with sparsity: 1,466 TFLOPS FP8)
...
GPU Memory: 80GB HBM3 (memory bandwidth: 3,350 GB/s)
Tensor Performance: 67 TFLOPS FP32, 3,958 TFLOPS FP8 (with sparsity), 1,979 TFLOPS BF16/FP16 (with sparsity)
...
L40S with 8x GPUs: 10 hours * $0.79/hr * 8 = $63.20
...
L40S: 91.6 TFLOPS
H100: 67 TFLOPS
Performance ratio: 1.37x in favor of L40S
...
L40S: 733 TFLOPS (with sparsity)
H100: 1,979 TFLOPS (with sparsity)
Performance ratio: 2.7x in favor of H100
...
L40S: Approximately 1,466 TFLOPS (FP8 via Ada tensor cores)
H100: 3,958 TFLOPS (dedicated Hopper tensor cores, with sparsity)
Performance ratio: ~2.7x in favor of H100
...
L40S: 1,466 TFLOPS (with sparsity, via Ada tensor cores)
H100: 3,958 TFLOPS (dedicated FP8 tensor cores, with sparsity)
Practical advantage: H100 ~2.7x better
...
L40S power consumption: 350W (specified at 350W)
...
Inference workloads with consistent demand: L40S becomes cost-effective at reasonable scale. If serving 100+ concurrent requests, the L40S's lower per-hour cost with more GPUs can be cheaper than fewer H100s. This calculation is sensitive to demand patterns and SLA requirements.
