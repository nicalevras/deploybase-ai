...
slug: h100-aws
description: >-
  AWS p5.48xlarge (8xH100) costs $98/hr on-demand. Explore spot discounts, EFA
...
|---|---|---|---|---|---|
| On-Demand | $98.16 | $71,657 | $859,718 | $12.27 | $12.27 |
| 1-Year Reserved | $49.08 | $35,828 | $429,859 | $6.14 | $6.14 |
| 3-Year Reserved | $42.82 | $31,258 | $375,029 | $5.35 | $5.35 |
| Spot (typical) | $29.45 | $21,499 | $257,987 | $3.68 | $3.68 |

Per-GPU on-demand: $12.27/hr ($98.16 / 8 GPUs). [RunPod H100 SXM](/gpus/runpod) runs $2.69/hr ($0.34 per GPU). But AWS includes 192 vCPU, 1.1TB RAM, and 400Gbps EFA networking. Worth maybe $15-20/hr on its own. Changes the math entirely.

**True Cost Comparison (Including CPU, Memory, Networking)**

| Component | AWS p5 Value | Standalone Cost | Total AWS TCO |
|---|---|---|---|
| 8x H100 GPU | $98.16/hr | Baseline | $98.16/hr |
...
| **Total AWS value** | - | - | **$99.66-101.31/hr** |
| Comparable RunPod setup | (8x single instances) | - | ~$21.52/hr (bare GPU) |
| Value added by AWS services | - | - | ~$78.14-79.79/hr premium |

AWS premium makes sense only if developers need managed services, IAM, and automated infrastructure. Otherwise overpay.

**Savings Plans**

AWS offers compute Savings Plans providing 50% discounts on on-demand pricing for 1-year or 3-year commitments. A p5.48xlarge under 1-year Savings Plan costs ~$49/hr, matching [CoreWeave's reserved pricing](/gpus/coreweave) per GPU ($6.12/GPU equivalent).
...
AWS's Spot pricing typically discounts p5.48xlarge to $29-35/hr (70% savings), making it competitive with dedicated providers for interruptible workloads. Savings calculation:

| Scenario | On-Demand Cost | Spot Cost | Savings |
|---|---|---|---|
| 24-hour training | $2,355.84 | $706.80 | $1,649.04 (70%) |
| 7-day training | $16,490.88 | $4,947.60 | $11,543.28 (70%) |
| 30-day training | $70,675.20 | $21,204 | $49,471.20 (70%) |
...
This approach enables p5 Spot usage for long-running training at $29/hr effective cost.
...
|---|---|---|---|
| 70B Llama-2 | 1 | 50 tokens/sec | $5.45 |
| 70B Llama-2 | 8 | 280 tokens/sec | $0.97 |
| 70B Llama-2 | 64 | 400 tokens/sec | $0.68 |
...
|---|---|---|---|
| 1x p5 | 1,000 tokens/sec | N/A | $98.16/hr |
| 2x p5 | 1,950 tokens/sec | 2.5% | $196.32/hr |
| 4x p5 | 3,850 tokens/sec | 3.2% | $392.64/hr |
...
|---|---|---|---|
| 3 months (2,190 hrs) | $215,007 | $107,486 | $107,521 |
| 6 months (4,380 hrs) | $430,013 | $214,972 | $215,041 |
| 12 months (8,760 hrs) | $860,026 | $429,859 | $430,167 |
...
1. Reserve 1x p5.48xlarge (1-year Savings Plan) = $49/hr baseline cost
...
| Lambda | $2.49/hr SXM | $19.92/hr |
| CoreWeave | $6.16/hr (8x cluster) | $49.24/hr |
| AWS | $12.27/hr on-demand | $98.16/hr |

AWS costs 3.6x more per GPU than [RunPod on-demand](/gpus/runpod), or 2x [CoreWeave](/gpus/coreweave).
...
For teams requiring integrated infrastructure, AWS becomes cost-competitive at 1-year Savings Plan rates ($49/hr → $6.12/GPU equivalent).
...
AWS excels for teams with 6+ member data science orgs requiring integrated IAM, logging, and managed services. For solo engineers or small teams, Lambda ($2.49/hr) or RunPod ($2.69/hr) provide better unit economics. AWS becomes cost-effective at annual Savings Plan rates ($49/hr) for sustained production workloads.

**How does AWS Spot pricing for p5.48xlarge compare to permanent reserved instances?**

Spot averages $29-35/hr (70% savings) versus on-demand $98.16/hr. For resumable workloads with checkpointing, Spot is optimal. For continuous serving, 1-year Savings Plan ($49/hr) offers better availability at lower cost.
...
For temporary experiments (< 1 week): Use Spot at $29/hr to minimize cost. Implement checkpointing for interruption tolerance. For medium-term (1-3 months): Use 1-year Savings Plan for 49% discount and guaranteed capacity. For one-time quick tests (< 4 hours): On-demand is acceptable despite high rate.

**How does AWS p5 TCO compare when factoring in managed services versus bare RunPod instances?**

AWS p5 ($98/hr on-demand) includes CPU, memory, networking, and managed service integration. Equivalent capability on RunPod (8x single H100 instances at $2.69/hr each = $21.52/hr) requires manual infrastructure, Docker/Kubernetes setup, and monitoring. AWS premium (~$76/hr) is justified for teams with >5 engineers who avoid writing infrastructure code. For small teams or researchers, RunPod provides better cost per GPU despite higher management overhead.
