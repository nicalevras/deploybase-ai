...
**March 2026 (Current):**
[OpenAI API pricing](/articles/openai-pricing): GPT-4o at $0.0025 input, $0.010 output
[Anthropic API pricing](/articles/anthropic-pricing): Claude Sonnet 4.6 at $0.003 input, $0.015 output
[Mistral API pricing](/articles/mistral-api-pricing): Mistral Large at $0.003 input, $0.009 output
[DeepSeek API pricing](/articles/deepseek-api-pricing): DeepSeek-V3.2 at $0.00028 input, $0.00042 output
...
|-------|----------|----------------------|------------------------|-----------------|
| GPT-4o | OpenAI | $0.0025 | $0.010 | $0.0075 avg |
| Claude Sonnet 4.6 | Anthropic | $0.003 | $0.015 | $0.011 avg |
| Mistral Large | Mistral | $0.003 | $0.009 | $0.007 avg |
| DeepSeek-V3.2 | DeepSeek | $0.00028 | $0.00042 | $0.00037 avg |
...
Break-even: 5-10M tokens/day depending on model and provider. [Lambda GPU pricing](/articles/lambda-labs-gpu-pricing) for H100 SXM ($3.78/hour) supports 2-3M tokens/day, costing $60-90/day. API costs for Mistral Large: 5M tokens at $0.0007 = $3.50, H100 at same throughput = $7.47. API wins below 3M tokens/day.
...
DeepSeek-V3 (best cost), Claude Sonnet 4.6 (best quality-to-cost), Mistral Large (good all-around). OpenAI GPT-4o best for critical applications.
