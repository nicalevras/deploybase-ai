...
Calculating inference cost for self-hosted deployments requires knowing the GPU hourly cost and tokens processed per hour. An H100 at $2.50/hour processing 5000 tokens/second costs $0.00018 per token ($2.50 / 14,000 tokens per hour), significantly below Claude's $3 per million ($0.000003 per token for input).
...
**Utilization Losses:** Cloud GPUs rarely run at 100% utilization. Traffic varies hourly; during low-traffic periods, paying $2.50/hour while processing 100 tokens/second is wasteful. Average utilization across typical workloads is 30-50% of capacity.
...
- Self-hosted: RunPod H100 at $2.50/hour × 730 hours = $1825/month (50% utilization assumption)
- Operational cost: 10 hours/month = $1000/month (staff time)
- Total self-hosted: $2825/month
