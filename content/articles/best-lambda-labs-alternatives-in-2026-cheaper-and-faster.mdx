...
|----------|---------|---------|---------|-----|----------|
| Lambda Labs | $1.48 | $2.49 SXM / $2.86 PCIe | $6.08 | 99.5% | Stable single-GPU |
...
Lambda Labs: (200×$1.48) + (120×$2.49) + (80×$6.08) = $296 + $298.80 + $486.40 = $1,081.20/month
...
Lambda Labs: $2.49 × 720 = $1,792.80/month = $21,514/year
...
For single-GPU production inference, Lambda's $2.49/hr SXM is the best value among dedicated providers.

### Scenario 4: Large-Scale Training (8x H100, 250 hours)

Lambda Labs: Cannot guarantee 8x capacity. Cost if available: 8 × $2.49 × 250 = $4,980
