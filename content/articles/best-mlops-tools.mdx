...
Yatai is the open-source component for building your own serving infrastructure. Kubernetes-native, supports air-gapped deployments, and works with existing monitoring stacks.
