...
A 70B parameter LLM in BF16 requires 140GB VRAM (70 billion × 2 bytes). The largest consumer GPU, NVIDIA [H100](/articles/nvidia-h100-price), provides 80GB memory. Large models don't fit without quantization, distributed inference, or offloading strategies.
...
2. **Do developers need fine-tuning?** Yes -> Keep weights full precision, quantize only for inference
