...
Navigate to the RunPod console and select "Create Pod." Search for "H200" in the available GPU filter. The interface displays hourly rates for on-demand and spot instances side by side.
