...
H100 has 80GB HBM3 memory, 14,080 CUDA cores, and tensor units. Built for data center workloads at scale.

70B models quantized to 4-bit fit comfortably in 80GB. Full-precision 70B needs ~140GB, so H100 forces quantization.

H100's tensor cores crush matrix multiplication. Throughput hits 60 TFLOPS for FP32, 1,457 TFLOPS for TF32 (training). For inference, quantized models (FP8) hit 5,825 TFLOPS. This translates to token generation at 200-400 tokens/second depending on batch size.
...
**H100**: 425W typical power draw
**RTX 4090**: 320W typical power draw

Monthly energy costs (electricity $0.12/kWh, continuous operation):
- H100: 425W × 730 hours × $0.12/kWh = $37/month
- RTX 4090: 320W × 730 hours × $0.12/kWh = $28/month
