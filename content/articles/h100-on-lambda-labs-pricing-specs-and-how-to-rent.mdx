...
H100 PCIe: 80GB HBM2e memory, 350W power, single PCIe 5.0 connection
...
H100 SXM on Lambda Labs: $3.78 per hour ($90.72/day, $2,759/month for 24/7 operation)
...
RunPod H100 PCIe: $1.99/hour
AWS H100 (p5.48xlarge, 8xH100): $55.04/hour ($6.88/GPU)
CoreWeave (single H100 implied): ~$6.16/hour (from 8xH100 pod pricing)
...
For H100 PCIe: RunPod charges $1.99/hr vs Lambda's $2.86/hr — RunPod is cheaper. For H100 SXM: RunPod charges $2.69/hr vs Lambda's $3.78/hr — RunPod is still cheaper. Lambda's advantage is managed infrastructure and guaranteed uptime rather than price.
