...
Gemini 2.5 Pro supports 2,000,000 tokens (2M context window). This is 4x larger than GPT-4.1 and 2x larger than Claude Opus.
...
- Input: (100,000 / 1,000,000) × $0.075 = $0.0075
- Output: (10,000 / 1,000,000) × $0.30 = $0.003
- Total: $0.0105
...
**Cost calculation:**
- $300 ÷ $0.075 per 1M input (Flash) = 4B input tokens free
...
**Example:**
- Upload 100k-token codebase (100k tokens @ $0.15 per 1M = $0.015)
- First call: Pay 100% for context = $0.015
- Next 1,000 calls reuse cache: Each pays 10% = $0.0015 per call
- Savings over 1,000 calls: $1.50 vs. $15 = 90% reduction
...
**Gemini 2.5 Flash is the cheapest input tokens.** OpenAI's newer models are cheaper than older Claude versions.
...
**Claude Opus is most expensive; Gemini 2.5 Flash is cheapest.**

### Cost-Effectiveness for Common Tasks

**Chatbot (short responses, high volume):**
- Gemini 2.5 Flash: $0.075 + $0.30 = $0.375 per 1M tokens (blended)
...
- Winner: Comparable; Gemini 2.5 Pro has 2M context advantage
...
- Input: (10,000 × 200) / 1,000,000 × $0.075 = $0.15
- Output: (10,000 × 150) / 1,000,000 × $0.30 = $0.45
- Monthly cost: $0.60
...
**Winner:** Gemini 2.5 Flash at $0.60/month (6x cheaper than GPT-5 Mini, 48x cheaper than Claude Sonnet).
...
- First contract: 200k × $0.075 + 5k × $0.30 = $16.50
- Cache setup cost: ~$7.50 (one-time)
- Subsequent contracts (reusing structure): 200k × $0.0075 + 5k × $0.30 = $3 each
- Monthly cost: $16.50 + 99 × $3 = $313.50

**Without cache:**
- Monthly cost: 100 × $16.50 = $1,650

**Savings from context cache: 81%**
...
**Using Gemini 2.5 Flash with Context Cache:**
- Codebase loaded once: 50k × $0.0075 (cache hit rate) = $0.375
- Per request: 500 × $0.075 + 1,000 × $0.30 = $0.3375
- Monthly: $0.375 + 1,000 × $0.3375 = $337.88

**Using Gemini 2.5 Pro (without cache optimization):**
- Per request: 50k × $1.25 + 500 × $1.25 + 1,000 × $10 = $73.125
- Monthly: 1,000 × $73.125 = $73,125

**Cost difference: Flash with cache ($338) vs. Pro without cache ($73,125) = 216x cheaper**
...
- Input: (10,000 × 2,000) / 1M × $0.075 × 0.5 = $0.75
- Output: (10,000 × 500) / 1M × $0.30 × 0.5 = $0.75
- Monthly: $1.50
