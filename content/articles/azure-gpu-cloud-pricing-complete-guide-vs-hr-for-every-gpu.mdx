...
- 8x H100 SXM (80GB): ~$27.00/hr
- Per H100: ~$3.38/hr
- Memory: 1900GB RAM
- CPUs: 96 vCPUs
- Storage: Premium SSD capable

8-GPU instance costs roughly $27/hr. Single H100 availability is limited. Most work uses full 8-GPU instances or multi-node clusters.

**Cost comparison:**
- Azure ND H100: $3.38/hr per GPU
- AWS p5 H100: $4.00/hr per GPU
- RunPod H100: $2.69/hr
- Vast.AI H100: $2.00-3.50/hr

Azure is slightly cheaper than AWS but more expensive than specialized providers.
...
**East US:** ~$27/hr for 8x H100
**West US 2:** ~$29/hr for 8x H100 (+7%)
**Europe West:** ~$32/hr for 8x H100 (+19%)
**Southeast Asia:** ~$35/hr for 8x H100 (+30%)
**Australia East:** ~$36/hr for 8x H100 (+33%)
...
**ND H100 (8x):**
- On-demand: $27.00/hr
- Reserved: ~$17.55/hr (-35%)

Annual cost: $17.55 × 8,760 = $153,738
...
**ND H100 (8x):**
- On-demand: $27.00/hr
- Reserved: ~$13.05/hr (-52%)

3-year cost: $13.05 × 8,760 × 3 = $342,378
...
Azure reserved pricing is actually lower than Vast.AI on-demand at full utilization. Azure advantage is integration, compliance, and SLAs; Vast.AI advantage is no upfront commitment and flexibility.
