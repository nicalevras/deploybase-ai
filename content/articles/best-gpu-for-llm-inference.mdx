...
48 GB memory enables loading 30B parameter models in FP16 with reasonable batch size support. The L40S uses GDDR6 rather than HBM, providing sufficient bandwidth for inference (960 GB/s) while keeping costs lower than HBM-equipped alternatives.
...
Memory bandwidth of 960 GB/s enables efficient throughput. The GPU does not suffer bandwidth starvation even with large batch sizes.
