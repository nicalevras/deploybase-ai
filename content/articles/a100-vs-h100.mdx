...
A100 (2020) vs H100 (2023). Three years gap. Bandwidth: 1,935 → 3,350 GB/s. Peak BF16 tensor: 312 → 989 TFLOPS.
...
| **Peak FP16 Tensor** | 312 TFLOPS | 989 TFLOPS | H100 3.2x | H100 |
| **Peak BF16 Tensor** | 312 TFLOPS | 989 TFLOPS | H100 3.2x | H100 |
...
| **Lambda** | H100 | SXM | $2.49 | $1,818 | $21,812 |

**Cost delta:** H100 is 68% more per hour (RunPod PCIe), 68% more (Lambda SXM).
