...
RunPod leads on cost transparency. RTX 4090 at $0.34 per GPU-second, H100 SXM at $2.69 per GPU-second, and B200 at $5.98 per GPU-second represent bottom-tier pricing for these hardware classes. RunPod's aggressive pricing strategy has forced competitors to cut costs.

Lambda Labs follows closely. H100 PCIe at $2.86 per hour matches RunPod's per-second equivalent pricing. Lambda's slightly higher rates reflect comprehensive support and reliability guarantees that RunPod doesn't emphasize.
