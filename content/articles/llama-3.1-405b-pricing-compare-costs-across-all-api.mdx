...
[Mistral Large pricing runs around $4/$12](/articles/mistral-api-pricing) per million tokens. Mistral pricing remains competitive with Llama 405B. Model selection involves capability assessment beyond pure cost comparison.
...
Most providers support 4K-32K context windows. Longer contexts increase input token costs proportionally.
