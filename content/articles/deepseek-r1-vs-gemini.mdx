...
DeepSeek R1 costs $0.55 input, $2.19 output per 1M tokens. Gemini 2.5 Pro costs $1.00 input, $10 output per 1M tokens.
...
- Gemini: 5,000 input tokens + 1,000 direct output tokens = $0.0150
...
- Gemini: 500,000 input tokens + 1,000 output tokens = $0.510
...
Cost: 50,000 input tokens × $1.00/M + 2,000 output × $10/M = $0.070
...
Cost: 10 × (500 input × $1.00/M + 200 output × $10/M) = $0.025
...
Cost: 100,000 input × $1.00/M + 500 output × $10/M = $0.105
...
- Gemini: 10 × (200K input × $1.00/M + 5K output × $10/M) = $2.50/month
...
- Gemini: 100 × (400K input × $1.00/M + 2K output × $10/M) = $42.00/month (single request per paper)
...
- Gemini: 1K × (2K input × $1.00/M + 500 output × $10/M) = $7.00/day = $210/month
- R1: 1K × (2K input × $0.55/M + 3K output × $2.19/M) = $7.67/day = $230/month
- Winner: Gemini (simpler questions, R1's reasoning overhead not justified)
