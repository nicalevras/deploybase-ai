...
L4 Runpod Pricing is the focus of this guide. The NVIDIA L4 represents an entry-level data center GPU optimized for inference and encoding tasks. This processor features 24GB of GDDR6 memory, 5,888 CUDA cores, and low power consumption of just 70W.
...
- CUDA Cores: 7,424
- Peak FP32 Performance: 121 TFLOPS
- Max Power: 70W
...
The L4 draws just 70W, so data centers can pack many units per rack.
