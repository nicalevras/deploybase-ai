...
- Input: 500 × ($0.15 / 1,000,000) = $0.000000075 × 500 = $0.000075
- Output: 200 × ($0.60 / 1,000,000) = $0.0000003 × 200 = $0.00012
- Total per request: $0.000195

**Winner: Google Gemini Flash by ~17x cost reduction**
...
Google Vertex (Gemini 2.5 Flash):
- 10,000,000 requests × $0.000195 = $1,950 daily
- Monthly cost: $58,500

**Savings with Gemini Flash: ~$916,500 monthly**
...
|----------|--------|-----------|
| High-volume API serving | Google Gemini 2.5 Flash | ~17x cost reduction vs GPT-4o |
...
- Google Gemini 2.5 Flash: 15M × ($0.15 / 1,000,000) = $2.25/day
- Monthly: $1,125 vs $67.50

Price difference: ~17x. Vendor choice matters enormously.
