...
Memory bandwidth matters more than capacity for inference. B200 at 8.6 TB/s handles dense matrix operations. B300 improvement to 10+ TB/s accelerates token generation 15-20%.
...
B200 power consumption: 500W per GPU
B300 power consumption: Estimated 600W per GPU

Data center considerations:
- Power delivery: Larger clusters need upgraded infrastructure
- Cooling: 20% higher power output demands enhanced cooling
- Cost per kilowatt-hour: $0.10-$0.15 in most data centers
- Monthly cooling cost (8x B200): ~400 kWh × $0.12 = $48/month
- Monthly cooling cost (8x B300): ~480 kWh × $0.12 = $58/month
- Annual cooling difference: $120
...
B200: 8.6 TB/second memory bandwidth
...
- TDP: 500W
- Thermal design suited to standard water cooling
- Most data centers handle easily

B300 thermal profile:
- Estimated TDP: 600W (20% increase)
...
- Time to train on 1.4T token dataset: 41 days (8x H100 cluster)
- Memory requirement: ~280GB (requires 2x GPUs minimum)
- Cost on cloud: $49.24/hour × 8 GPUs = $35,935/month
...
- B200: $1,197/day
- B300: $1,351/day (13% more expensive)

Training speedup (7 days faster) worth $8,379 cost difference? Depends on time-value.
