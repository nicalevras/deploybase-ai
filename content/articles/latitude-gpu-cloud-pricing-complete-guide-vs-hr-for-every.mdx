...
Performance metrics show H100s delivering 1979 TFLOPS for FP32 operations. For mixed-precision workloads common in LLM inference, peak performance reaches 7918 TFLOPS.
...
- [Lambda GPU pricing](/articles/lambda-labs-gpu-pricing) H100 SXM: 1000 × $2.49 = $2,490
- [AWS GPU pricing](/articles/aws-vs-azure-gpu-pricing) on-demand: 1000 × $4.20 = $4,200

Latitude's H100 rate of $3.50 is higher than Lambda's $2.49/hr H100 SXM. AWS remains the most expensive option. Latitude saves $700 versus AWS (16.7%) on equivalent training time.

For continuous training over 60 days:
- Hours: 1,440
- Latitude: 1,440 × $3.50 = $5,040
- Lambda H100 SXM: 1,440 × $2.49 = $3,586
...
- Comparable to [Lambda](/articles/lambda-labs-gpu-pricing) H100 SXM ($2.49/hr) though Latitude's H100 rates run slightly higher
