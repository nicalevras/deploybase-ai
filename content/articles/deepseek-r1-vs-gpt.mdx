...
|-----------|-------------|---------|-----|------|
| API input price | $0.55/M | $2.50/M | $10.00/M | DeepSeek |
| API output price | $2.19/M | $15.00/M | $40.00/M | DeepSeek |
| Parameter count | 671B (37B active) | | | DeepSeek (transparent) |
| Context window | 256K | 272K | 200K | GPT-5.4 |
...
| Cost/1B tokens (50M in+50M out) | $140 | $1,325 | $2,500 | DeepSeek |
...
**o3 via OpenAI:**
- Input: 100M × $10.00/M = $1,000
- Output: 50M × $40.00/M = $2,000
- **Total: $3,000**

DeepSeek R1 is 94% cheaper than o3.
...
- o3: $6,000 + $16,000 = **$22,000/month**

The gap widens at scale. DeepSeek R1 is 6x cheaper than GPT-5.4, 18x cheaper than o3. For cost-sensitive applications (batch processing, research, non-interactive workloads), R1 is the obvious choice.
