...
**Per H100 (from 8-GPU cluster):** $6.16/hour
**Uptime:** 99.95% SLA
...
**p5.48xlarge (8x H100):** $55.04/hour
...
**A100 GPU (1x 80GB):** $5.07/hour
**H100 SXM (8x cluster):** $88.49/hour ($11.06/GPU)
...
**ND96asr_A100 (8x A100):** $32.77/hour
...
Lambda Labs ($3.78/H100 SXM, 99.9% SLA) or CoreWeave ($49.24/8x H100 cluster, 99.95% SLA). AWS and Azure provide higher SLAs but cost 2-3x more.
