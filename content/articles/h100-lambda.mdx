...
slug: h100-lambda
description: >-
  Lambda H100 costs $2.86/hr (PCIe) and $2.49/hr (SXM). Explore reserved pricing
...
**H100 Lambda Labs** runs $2.86/hr (PCIe) or $2.49/hr (SXM). Dedicated capacity, no spot terminations, NVLink multi-GPU setups. Good for production training that can't handle interruptions.
...
| H100 SXM (1x) | $2.49 | $1,818 | $21,812 | $0.0138 |
| H100 PCIe (2x) | $5.72 | $4,176 | $50,112 | $0.0318 |
| H100 SXM (8x) | $19.92 | $14,542 | $174,504 | $0.1107 |
...
|---|---|---|---|---|
| On-Demand | $2.86 | $2.49 | $19.92 | Baseline |
| 3-Month Reserved | $2.57 | $2.24 | $17.92 | 10% |
| 6-Month Reserved | $2.43 | $2.12 | $16.96 | 15% |
| 12-Month Reserved | $2.29 | $1.99 | $15.92 | 20% |

A single H100 PCIe reserved for 12 months costs approximately $20,044 annually (versus $25,056 on-demand), saving $5,012 per instance. For 8x SXM clusters, 12-month reservations save approximately $35,000 annually compared to on-demand.
...
Lambda pre-configures multi-GPU clusters with NVLink. 2x H100 SXM is $4.98/hr, 4x is $9.96/hr. No manual network setup.
...
Lambda's H100 SXM at $2.49/hr is cheaper than RunPod H100 SXM (~$2.49-2.69/hr) and significantly below CoreWeave's cluster pricing ($6.16/GPU). The H100 PCIe at $2.86/hr is slightly higher but fits standard server slots. The key trade-off: Lambda offers guaranteed dedicated capacity and simplified multi-GPU setups, whereas RunPod prioritizes lowest single-GPU cost on the spot market.
...
Lambda's 8x H100 SXM cluster costs $30.24/hr versus AWS p5.48xlarge at ~$98/hr (8xH100 PCIe + CPU). However, AWS instances include CPU, storage, and managed services. For pure GPU compute, Lambda is 3x cheaper. See [AWS [GPU pricing](/gpus) comparison](/gpus/models/nvidia-h100) for details.
...
Lambda supports incremental scaling without data loss. Workflow: (1) Train on single H100 PCIe ($2.86/hr), (2) periodically save full checkpoints to S3, (3) when model complexity requires more GPU, launch 4x H100 SXM cluster ($15.12/hr), (4) restore latest checkpoint and continue training with distributed training framework (PyTorch DDP). This approach minimizes upfront commitment while enabling smooth scaling as needs evolve.
