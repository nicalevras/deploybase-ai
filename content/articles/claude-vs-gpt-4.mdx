...
**Haiku 4.5:** $0.80/$4/M. Fast, cheap. 44 tok/sec (faster than Sonnet). Trade: weak on complex. Use for classification, summarization, high-volume where speed matters.
...
3. **Multimodal is needed.** GPT-4o supports images; Claude Sonnet 4.6 does not (Opus 4.6 does).

### Use Claude Haiku or GPT-4o Mini When:

1. **Cost is paramount.** $0.80/M prompt pricing on Haiku, sub-$0.15/M on GPT-4o Mini.
...
**Should teams use 1M-context models?**
...
**Can teams use multiple models in production?**
