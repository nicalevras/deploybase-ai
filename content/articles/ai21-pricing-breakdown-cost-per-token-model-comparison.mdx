...
Claude Haiku at $0.00025 input and $0.00125 output tokens cheapest among major providers. Cost-per-capability ratio highly favorable. Output quality lower but adequate for many uses.

AI21 Ultra at $0.35 input and $1.05 output 100x more expensive than Claude Haiku. Pricing premium unjustified for most applications. Specialized compliance requirements or proprietary needs required.
...
AI21 Mid breaks even with OpenAI on pricing despite different capability profiles. Anthropic undercuts both by 4-5x. Capability requirements drive provider selection.

Annual costs for 100M tokens:
- AI21 Mid: $1,100
- OpenAI GPT-4 Turbo: $1,100
- Anthropic Claude: $240
