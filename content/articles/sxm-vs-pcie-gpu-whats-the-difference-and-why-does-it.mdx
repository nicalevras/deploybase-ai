...
|--------|-----|---------|---------|
| Bandwidth | 900 GB/s | 256 GB/s | 128 GB/s |
...
PCIe 6.0 promises 960 GB/s bandwidth (vs 256 GB/s on PCIe 5.0). Still slower than SXM NVLink but gap narrows. Available mid-2026+ (not yet mainstream).
