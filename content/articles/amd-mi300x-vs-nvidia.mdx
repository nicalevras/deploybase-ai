...
The MI300X represents AMD's flagship data-center AI accelerator, released in late 2024 and widely available in cloud environments by mid-2025.
...
- GPU cores: 13,440 stream processors
- Peak FP32 performance: 163 TFLOPS
- Peak FP8 performance: 1,307 TFLOPS
- Peak INT8 performance: 1,307 TOPS

**Tensor Engine Details**
- Matrix multiplication units: 1,920 per GPU
- Supported precisions: FP32, FP16, BF16, TF32, FP8, INT8
- Tensor block size: 64x64 (compared to H100's varying configurations)

**Power and Thermal**
- Thermal Design Power (TDP): 550W per GPU
- Cooler requirement: Dual-slot passive cooler adequate
...
- Peak FP32 performance: 60 TFLOPS
...
MI300X operates at 550W TDP versus H100's 700W, reducing data center cooling requirements.

**Power Cost Impact**

At typical data center power cost ($0.08/kWh):
- H100: 700W × 24 hours × $0.08/kWh = $0.135 per day per GPU
- MI300X: 550W × 24 hours × $0.08/kWh = $0.106 per day per GPU
- 8-GPU cluster savings: $0.232 per day or $85 annually

Data center cooling costs (often 30-40% of total power cost) drop further with MI300X's lower heat output. Teams maintaining large-scale training clusters (100+ GPUs) save $50k+ annually through power reduction alone.
...
- B200: 192 GB HBM3e, 18 TFLOPS peak FP8 (with sparsity)
