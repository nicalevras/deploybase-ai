...
Lambda doesn't offer serverless Llama 4 inference. Cost is GPU rental (pay for instance, run your own vLLM server).
...
| Lambda | H100 self-host | N/A | N/A | $3.78/hr | $0.022 | Reliability priority |
...
A single H100 cannot handle 3.6B tokens monthly. Multiple GPUs are needed.
