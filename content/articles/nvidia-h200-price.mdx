...
| Single GPU | Lambda GH200 | $1.99 | 96GB | 1x |
| 8-GPU Cluster | CoreWeave H200 | $50.44 | 1,128GB | 8x |

The Lambda GH200 at $1.99/hr is technically a different chip (NVIDIA's Grace Hopper CPU-GPU combo), but it occupies the same market slot for inference. The H200's raw specs are superior: 141GB vs 96GB, 4.8 TB/s vs 3.0 TB/s bandwidth. However, GH200 availability is limited, and workload optimization for Grace CPU cores is a learning curve.
...
- **Memory:** 141GB HBM3e
- **Bandwidth:** 4.8 TB/s
- **Compute:** 3,958 TFLOPS FP8, 1.979 TFLOPS FP64
- **NVLink:** 900 GB/s per GPU when using NVLink 5
- **TDP:** 500W typical operation
