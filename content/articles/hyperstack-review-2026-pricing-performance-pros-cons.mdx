...
- Mid-tier (A100, RTX 4090): $0.80-1.50/hour
- High-end (H100, H200): $2.50-4.00/hour

Spot/preemptible instances discount standard rates by 40-60%, suitable for fault-tolerant workloads. Reserved capacity plans lock in discounts for committed usage. These options reduce effective rates for long-duration training.
...
Performance metrics align with standard GPU specifications. H100s deliver 141 TFLOPS FP32, matching hardware across all providers. Differences emerge in implementation details: memory bandwidth, NVLink configuration, and host CPU quality.
...
[Lambda](/articles/lambda-labs-gpu-pricing) focuses on simplicity plus reliability. Lambda maintains more stable pricing and inventory. Lambda H100s cost $2.49/hour (SXM) on Lambda's reliability justifies the minimal cost difference.
