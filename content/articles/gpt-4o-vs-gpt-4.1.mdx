...
GPT-4.1 if context is large (full documents + retrieval results fit in 1.05M tokens). GPT-4o if context is small (<300K tokens) and retrieval quality matters more than cost. Neither is ideal for RAG; Claude Opus (200K context, $5/$25 pricing) or Llama 70B (self-hosted) often outperform on document grounding due to better long-context reasoning.
