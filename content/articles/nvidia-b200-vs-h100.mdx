...
- **Training sparse models**: Sparsity engine provides 2x speedup. When training models with structured sparsity (50%+ weights zero), B200 gains compound advantage.
