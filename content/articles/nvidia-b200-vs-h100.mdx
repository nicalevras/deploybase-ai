...
Peak FP32 performance: 60 TFLOPS. TF32 Tensor: 1,457 TFLOPS. FP8 Tensor: 5,825 TFLOPS.
...
Peak FP32: 120 TFLOPS (2x H100). TF32 Tensor: 2,914 TFLOPS. FP8 Tensor: 11,650 TFLOPS (2x). FP6 Tensor: 17,475 TFLOPS (new).
...
| **Peak FP32** | 60 TFLOPS | 120 TFLOPS | B200 (2x) |
| **Peak FP8** | 5,825 TFLOPS | 11,650 TFLOPS | B200 (2x) |
...
| **Price/GPU-hr** | $1.99-$2.49 | $5.98-$6.08 | H100 (cheaper) |
...
B200 doubles the FP8 throughput (11,650 TFLOPS vs 5,825 TFLOPS). Inference on FP8 models runs 2x faster on B200. The speedup doesn't require retraining; older models quantized for H100 run 2x faster on B200 with zero code changes.
...
MI300X: 192GB HBM3e, 5.3 TB/s bandwidth. B200: 192GB HBM3e, 8.0 TB/s bandwidth. B200 is 1.5x faster on bandwidth. MI300X has comparable VRAM. On proprietary benchmarks, B200 typically leads MI300X by 15-25% on LLM inference, but open-source benchmarks are scarce. Both are significantly more expensive than H100.
