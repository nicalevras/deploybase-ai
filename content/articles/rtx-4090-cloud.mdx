...
| **Peak FP32** | 82.6 TFLOPS | 19.5 TFLOPS | 60 TFLOPS | 660 TFLOPS | B200 (8x) |
...
| **TDP** | 320W (typical) | 400W | 700W | 1,000W | RTX 4090 (lowest) |
...
Thermal throttling happens. The 4090 runs at 320W. After 10-15 minutes, it hits 80-85°C. Thermal governors kick in, cut clocks, drop throughput 15-25%. A100 and H100 have better thermal design (built for 24/7 datacenters).
...
The 4090 is 1.5-2x faster (same 24GB VRAM, better architecture). It's 2.25x cheaper on RunPod ($0.34 vs $0.51). Pick 4090. 3090 is only for historical comparisons.
