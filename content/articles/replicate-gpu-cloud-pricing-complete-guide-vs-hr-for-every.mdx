...
[Lambda prices](/articles/lambda-labs-gpu-pricing) H100 SXM at $2.49/hour. Replicate's H100 runs ~$0.001/second, or $3.60/hour continuous — somewhat more expensive than Lambda for sustained use, different billing model.
