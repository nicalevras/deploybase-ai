...
H100 on AWS ships as p5.48xlarge instances: 8 H100s for ~$98/hr on-demand. That's ~$12.25/GPU. RunPod charges $2.69/GPU. AWS costs significantly more because developers get SageMaker, VPC integration, 99.99% SLA, and managed services. Worth it if developers need that ecosystem.
...
p5.48xlarge on-demand pricing: ~$98/hour (as of March 2026)
...
Per-GPU cost: $98/8 = ~$12.25/hour per H100 on-demand

Monthly cost for 24/7 operation: $98 × 24 × 30 = $70,560/month

Spot instances pricing:
- p5.48xlarge spot: ~$31-41/hour (varies by region and availability)
- Monthly spot cost at $35/hr: $35 × 24 × 30 = $25,200/month (60-70% savings)

Spot instances terminate with 2-minute notice, unsuitable for non-resumable workloads.

### Why AWS Costs More

RunPod: $2.69/GPU/hr. AWS p5: ~$12.25/GPU/hr on-demand. The premium covers:
...
AWS p5 (8x H100 SXM): ~$98/hr = ~$12.25/hr per GPU
...
Use Spot Instances for fault-tolerant workloads. p5 spot instances cost 60-70% less than on-demand (~$31-41/hour vs ~$98/hour). Spot instances terminate with 2-minute notice.
