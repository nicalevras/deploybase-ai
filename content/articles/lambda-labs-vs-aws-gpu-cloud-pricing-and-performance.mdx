...
H100 pricing diverges sharply. Lambda H100 SXM: $2.49/hour. AWS p5.48xlarge: ~$12.25/hour per GPU on-demand. Lambda advantage: ~80% savings per GPU. AWS advantage: managed services, SageMaker integration, regional availability, reserved instances.
