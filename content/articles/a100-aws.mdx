...
slug: a100-aws
description: >-
  AWS p4d.24xlarge (8xA100) costs $32.77/hr on-demand. Explore reserved pricing,
...
**A100 AWS** is available exclusively through p4d.24xlarge instances with 8xA100 GPUs, high-performance CPUs, and networking. On-demand pricing is approximately $32.77 per hour. That's 3x more expensive than dedicated providers on raw cost, but includes managed services, IAM, and automated scaling.
...
|---|---|---|---|---|---|
| On-Demand | $32.77 | $23,922 | $287,051 | $4.10 | $4.10/GPU |
| 1-Year Reserved | $16.38 | $11,957 | $143,525 | $2.05 | $2.05/GPU |
| 3-Year Reserved | $14.33 | $10,461 | $123,846 | $1.79 | $1.79/GPU |
| Savings Plan (1-year) | $16.38 | $11,957 | $143,525 | $2.05 | $2.05/GPU |
| Spot (typical) | $9.83 | $7,176 | $86,108 | $1.23 | $1.23/GPU |

Per-GPU on-demand cost: $4.10 (8 A100s / $32.77/hr). This exceeds dedicated providers: [RunPod A100 costs $1.19/hr](/articles/a100-runpod) ($0.15/GPU per single instance), making AWS on-demand 27x more expensive per GPU. However, AWS includes CPU, RAM, networking, and managed services worth $15-20/hr separately.
...
AWS compute Savings Plans provide 50% on-demand discounts for 1-year or 3-year commitments. A p4d.24xlarge under 1-year Savings Plan costs ~$16.38/hr ($2.05/GPU), matching [CoreWeave's reserved pricing](/articles/coreweave-gpu-pricing) while providing integrated AWS services.
...
AWS Spot pricing for p4d.24xlarge averages $9.83/hr (70% savings), making it competitive with CoreWeave reserved pricing ($13.82/hr for 8xA100).
...
For resumable workloads with checkpointing, Spot p4d ($9.83/hr) provides exceptional value.
...
|---|---|---|
| Hourly Rate | $32.77 | $98.16 |
| Per-GPU Cost | $4.10 | $12.27 |
| Performance | 312 TFLOPS | 989 TFLOPS |
...
AWS excels for teams requiring integrated IAM, logging, compliance, and multi-team cost allocation. For solo engineers or small teams prioritizing GPU cost alone, [RunPod A100 at $1.19/hr](/articles/a100-runpod) is 27x cheaper. AWS becomes cost-competitive at 1-year Savings Plan rates ($16.38/hr = $2.05/GPU) for sustained workloads exceeding 6 months when including managed services value. Compare [Lambda A100 reserved pricing](/articles/lambda-labs-gpu-pricing) and [CoreWeave Kubernetes clusters](/articles/coreweave-gpu-pricing) for alternative production setups.

**Should I use p4d Spot instances for training?**

Yes, if implementing checkpointing and tolerating rare interruptions. Spot at $9.83/hr saves $23/hr versus on-demand. For a 100-hour training job, Spot saves $2,294. The trade-off: occasional reruns from checkpoints versus guaranteed on-demand execution.
...
| AWS p4d Spot | $9.83 | $983 | 1 hour ($150) | $1,133 |
| AWS p4d Reserved (break-even) | $16.38 | $1,638 | 1 hour ($150) | $1,788 |
