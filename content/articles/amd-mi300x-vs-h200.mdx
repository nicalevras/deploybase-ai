...
- Compute: 40 TFLOPS (FP32), 160 TFLOPS (FP8)
- Manufacturing: 5nm process
- Interconnect: Infinity Fabric (300 GB/s GPU-to-GPU)
- Release: December 2023

**NVIDIA H200 Architecture (Hopper):**
- Memory: 141GB HBM3e
- Memory bandwidth: 4.8 TB/s
- Compute: 67 TFLOPS (FP32), 268 TFLOPS (FP8)
...
- MI300X: $4.00-5.00/hour (limited availability)
- H200 (RunPod): $3.59/hour
- H200 (Lambda): ~$4.02/hour (approximate; Lambda H200 pricing varies)

MI300X pricing approaches H200 despite superior memory specifications. The availability premium reflects limited supply and specialized support requirements.
...
MI300X single-GPU approach:
- Monthly cost: $5.00/hour × 730 hours = $3,650
...
MI300X achieves 30% cost reduction for single large models through simpler deployment. However, operational complexity and availability constraints often offset this advantage.
...
- Peak bandwidth per GPU: 300 GB/s
- 8-GPU ring topology: 300 GB/s per GPU (fully saturated)
...
MI300X approach (2x MI300X):
- Monthly cost: 2 × $4.50/hour × 730 hours = $6,570
- 3-year cost: $236,520
...
MI300X advantage: $141,192 (37% savings) for this specific scenario.
