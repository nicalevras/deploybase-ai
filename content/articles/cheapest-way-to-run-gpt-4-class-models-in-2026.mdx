...
Fine-tuning cost calculation: training on 10K example pairs. H100 time: 4-6 hours. Cost: $15-23 using [Lambda Labs](/articles/lambda-labs-gpu-pricing) at $3.78/hour (SXM). LoRA-based fine-tuning reduces GPU time to 1-2 hours, bringing cost to $2.50-5.
...
H100 options from [Lambda Labs](/articles/lambda-labs-gpu-pricing) ($3.78/hour SXM) or [AWS](/articles/aws-vs-azure-gpu-pricing) (~$12.25/hour per GPU on p5 instances). GPU costs dominate. 30 days continuous operation: Lambda $2,722, AWS $8,820.
