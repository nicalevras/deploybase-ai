...
|------|--------|-------|----------|----------|-------|
| 1 | Cursor | $20/mo | Best all-around IDE | Claude Sonnet 4.6 / GPT-4o | 360K+ paying |
| 2 | Windsurf | $19/mo | Agentic multi-file editing | Claude Sonnet 4.6 / GPT-4o | 50K+ users |
...
- Customizable (configure your own backend)
