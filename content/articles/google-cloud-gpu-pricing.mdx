...
**Google cloud gpu pricing** depends on instance family, region, commitment level, and workload. Pick the wrong instance type and you'll pay 2x-5x more than necessary. GPU costs eat most ML infrastructure budgets, so optimization matters.
...
On-demand: maximum flexibility, highest cost. Pay for what you use, no commitment. Costs add up fast.

**Spot instances** give 70% discounts but can be yanked with 30 seconds notice. Great for:
- Training (checkpointing allows resuming interrupted training)
...
**Committed use discounts (CUDs)** lock in 40-49% savings for 1-3 years. You pay upfront for capacity at reduced rates. Makes sense when the load is predictable: 24/7 training for months, persistent serving endpoints.
...
The $480 training example above gets expensive fast. Add 500GB data upload ($10) and 1TB storage ($20) and you're at ~$510.

## Cost Monitoring and Alerts

GCP has built-in tools:

**Billing alerts**: Set budgets. Get notified before limits are hit.
...
**Carbon-aware scheduling**: Pick times when renewable energy is high. European regions get green hours. GCP lets teams schedule jobs then, cutting carbon and costs together.
...
The compounding wins are real. Save 20% monthly on GPU and you're saving $24k/year on a $10k/month budget. That's free engineer capacity. GCP's advantage means the team can do more ML per dollar than AWS customers.
