...
- **a2-highgpu-1g**: 1x A100 80GB, 12 vCPU, 85GB RAM
  - On-demand: $1.19/hour
  - Spot: $0.36/hour (70% discount)
  - 1-year CUD: $0.71/hour (40% savings)
  - 3-year CUD: $0.60/hour (49% savings)

- **a2-highgpu-8g**: 8x A100 80GB, 96 vCPU, 680GB RAM
  - On-demand: $9.52/hour
  - Spot: $2.86/hour
  - 1-year CUD: $5.71/hour
  - 3-year CUD: $4.80/hour

- **a2-megagpu-16g**: 16x A100 80GB, 192 vCPU, 1,360GB RAM
  - On-demand: $19.04/hour
  - Spot: $5.71/hour
  - 1-year CUD: $11.42/hour
  - 3-year CUD: $9.60/hour

Per-GPU: $1.19/hour on-demand for a2-highgpu-1g. Scale to 8 GPUs and per-GPU cost stays the same ($9.52 / 8 = $1.19). Volume pricing is flat here, but larger instances still win through utilization gains.
...
- **a3-highgpu-8g**: 8x H100 80GB, 104 vCPU, 1,457GB RAM
  - On-demand: $15.24/hour
  - Spot: Not available (Google restricts)
  - 1-year CUD: $10.67/hour (30% savings)
  - 3-year CUD: $9.14/hour (40% savings)

- **a3-megagpu-16g**: 16x H100 80GB, 208 vCPU, 2,915GB RAM
  - On-demand: $30.48/hour
  - Spot: Not available
  - 1-year CUD: $21.34/hour
  - 3-year CUD: $18.28/hour

H100s cost more per GPU: $1.905/hour vs $1.19 for A100s. Worth it only if developers get 2x performance on the workload. If developers're memory-bound instead of compute-bound, the extra cost doesn't help.
...
- GCP A2: $1.19
- AWS EC2 p3.2xlarge: $3.06
- Azure Standard_ND40rs_v2: $3.48

GCP's 60% cheaper. AWS p3dn (with NVMe) is worse at $4.42/hour.

**H100 Pricing (per hour, on-demand)**:
- GCP A3 (per GPU): $1.905
- AWS EC2 p4de: Not widely available, estimated $8+/hour
- Azure ND H100 v5: $4.98/hour

GCP's roughly half of AWS p4de pricing.
...
**Bottom line**: GCP wins on A100s (A2), matches competitors on H100s (A3), competitive on L4 (G2). AWS and Azure have more instance types but cost more. For GPU compute cost optimization, [GCP usually wins](/gpus/googlecloud).
...
- Hardware: a2-highgpu-8g (8x A100, $9.52/hour)
- Spot discount (70%): $2.86/hour
- Duration: 168 hours (7 days)
- Total: 168 hours × $2.86 = $480.48
...
- Training: 5 a2-highgpu-1g instances (5x $1.19 = $5.95/hour) 8 hours daily
- Training monthly: $5.95 × 8 × 30 = $1,428
- Serving: 2x g2-standard-8 instances ($0.88/hour) 24/7
- Serving monthly: $643.40
- Total: $2,071.40/month (before storage, data transfer, other services)
...
- GCP a2-highgpu-1g: $1.19/hour × 168 = $200
- AWS p3.2xlarge: $3.06/hour × 168 = $514
- Azure Standard_ND40rs_v2: $3.48/hour × 168 = $585

GCP wins by 60%, saving $314/month per GPU.

**8-GPU training cluster (7 days intensive)**:
- GCP a2-highgpu-8g (spot): $2.86/hour × 168 = $480
- AWS p3.8xlarge (spot): $9.70/hour × 168 = $1,630
- Azure ND40rs_v2 (reserved): $10/hour × 168 = $1,680

GCP wins by 70%, saving $1,150+ per training run.
...
**The math**: $10k/month AWS GPU budget becomes $4k on GCP. Save $72k/year. Often worth migrating for that alone.
