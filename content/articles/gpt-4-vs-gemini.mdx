...
| **Gemini 2.5 Pro** | 400K | $1.25 | $5.00 | $0.25 | Fastest inference, code exec |
| **Gemini 2.5 Flash** | 400K | $0.075 | $0.30 | $0.04 | Budget tier, 400K context |
| **Claude 3.5 Sonnet** | 1M | $3.00 | $15.00 | $1.50 | Best at coding, refactoring |
...
- Completion: 100K × $5.00/M = $0.50
- Monthly: $1.125

Gemini saves $1.125/month (50% cheaper).
...
- Context: 400K tokens (smaller than GPT-4.1)
...
- Released: March 2025
- Context: 400K tokens
- Pricing: $0.075 prompt, $0.30 completion per M
...
### Gemini 2.5 Pro (400K Context)

Gemini's 400K context is practical for most use cases (entire GitHub repos, long documents, chat history).
...
For most applications, 400K is sufficient. The extra 650K tokens in GPT-4.1 matters only for massive codebase analysis or archival document processing. For typical use, Gemini wins (speed + cost).
...
- Gemini 2.5 Flash: $0.10 per 1M input tokens
...
- US regions: standard pricing ($1.25 prompt, $5 completion for Gemini 2.5 Pro)
...
Gemini Flash at $0.075/M is unbeatable on price.

**Context window is 400K or less:**
- Most production workloads fit this
- Cheaper and faster than GPT-4.1's 1.05M
...
Claude 3.5 Sonnet ($3.00 prompt, $15.00 completion) is excellent for coding and refactoring but more expensive than GPT-4o. Choose Claude if coding quality is critical, otherwise GPT-4o or Gemini.
...
GPT-5 (OpenAI): rumors of Q3 2026 release, improved reasoning.
