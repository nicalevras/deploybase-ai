...
**Key Products:** MI300X (HBM3e, 192GB), MI350 (in sampling). EPYC CPUs (server-grade).
...
- Pricing: $35-50/hr for 8x H100 clusters (30-40% premium vs AWS, but lower commitment minimums)
...
- Pricing: $2.86/hr for single H100 PCIe (competitive vs RunPod)
...
- Pricing: Cheapest single-GPU option ($1.99/hr for H100 SXM). Attracts cost-sensitive researchers
