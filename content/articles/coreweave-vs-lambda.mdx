...
|----------|------------|----------|
| Lambda | 8x H100 SXM (extrapolated) | ~$21.68 |
| CoreWeave | 8x H100 SXM cluster | $49.24 |

Lambda offers 8x H100 SXM at $21.68/hr. CoreWeave's equivalent 8x cluster is $49.24/hr. CoreWeave costs 2.27x more. Why would anyone choose CoreWeave?

**The hidden costs of Lambda's pricing**

Lambda's per-GPU SXM rate is $2.49 for a single H100 SXM. Multiply by 8: $19.92/hr for an 8x cluster. CoreWeave plays differently.
...
Lambda 8x H100 SXM:
- Weekly: $21.68/hr × 168 hours = **$3,642**
- Monthly: $3,642 × 4.3 = **$15,660**

CoreWeave 8x H100:
- Weekly: $49.24/hr × 168 hours = **$8,272**
- Monthly: $8,272 × 4.3 = **$35,570**

Lambda is 2.27x cheaper. But Lambda's cluster is also ~5% less reliable in distributed training due to non-dedicated orchestration. CoreWeave's overhead buys teams stability.
...
| H100 SXM | $2.49 | $6.16 (÷8) | Lambda (2.5x) |
...
**Key insight:** Lambda dominates per-GPU pricing across all models except H200 (CoreWeave only). Lambda's advantage is largest for older, high-volume GPUs (A100: 82% cheaper). Even on newest hardware (B200), Lambda is still 41% cheaper per GPU.
...
Lambda: 336 hours × $21.68/hr = **$7,284**
CoreWeave with InfiniBand: 336 hours × $53.24/hr = **$17,889**

Lambda is 2.45x cheaper. But CoreWeave's built-in cluster stability and networking mean training runs are less likely to crash mid-epoch. Lambda requires custom orchestration. One failed all-reduce at hour 200 and teams restart from hour 180 (checkpoints 6 hours apart). Costs compound.

Adjusted cost (accounting for potential restarts):
- Lambda: $7,284 + ($7,284 × 0.15 restart overhead) = **$8,377**
...
Lambda: 2 × $2.49/hr × 730 hours = **$3,635/month**
...
Lambda: 8x H100 at $19.92/hr for same throughput. 200 hours × $19.92 = **$3,984**

Lambda saves $5,512. But Lambda's single-GPU focus means teams are paying for idle capacity or running suboptimal batch sizes. CoreWeave's orchestration enables better packing.
...
Lambda for <8 GPU workloads. 2.3x cheaper at single-GPU. CoreWeave for 8+ GPU clusters where orchestration overhead on Lambda becomes significant. At 8x H100 scale, CoreWeave's built-in management can offset its 2.27x higher per-GPU cost through reliability gains.
