...
[RunPod offers RTX 3090 at $0.22/hour](/articles/runpod-gpu-pricing) for smaller model experimentation. For serious production work with large models, check [Lambda's H100 pricing at $2.49/hour SXM](/articles/lambda-labs-gpu-pricing).
