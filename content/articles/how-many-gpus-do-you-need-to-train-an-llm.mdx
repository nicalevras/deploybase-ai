...
Models trained on high-quality data converge 20-30% faster (fewer tokens needed for target loss). Poor data requires 20-30% more tokens. GPU count stays same, but training time changes.
