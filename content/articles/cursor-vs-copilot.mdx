...
- GPT-4o (OpenAI)
- Claude Opus (Anthropic, reasoning mode)

Subscription options:
- Free tier (50 requests/month)
- $20/month (unlimited requests, Claude Sonnet)
- $120/month (Pro, Claude Opus + faster models)
...
| **Advanced Models** | GPT-4o, o1 | Claude Opus ($120/mo Pro) |
...
Strengths:
- Claude Sonnet 3.5: superior at codebase understanding, refactoring, explaining code logic
