...
**Memory Bandwidth:**
300GB/s bandwidth is roughly 1/11th of H100 SXM (3.35TB/s) but sufficient for single-model inference. Latency-critical token generation benefits from tight compute-to-memory balance.
