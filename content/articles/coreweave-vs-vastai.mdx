...
CoreWeave single H100: ~$3.00/hour (estimated single-unit on-demand rate; annual discount applied) × 8,760 = $26,280

VastAI single H100: $2.75/hour × 8,760 = $24,090

**Winner: VastAI by $2,190 on cost** (but CoreWeave's reliability advantage is worth far more for production inference)

### Scenario: Development and Experimentation (200 hours/month)

CoreWeave: ~$3.00/hour × 200 = $600/month = $7,200/year (single H100, estimated on-demand rate)

VastAI: $2.25/hour × 200 = $450/month = $5,400/year

**Winner: VastAI by $1,800** (acceptable risk for non-critical work)
...
CoreWeave approach:
- Reserve 1x H100: ~$3.00/hour (estimated single-unit on-demand rate)
- 200 hours monthly: $600/month
- Operational overhead: Minimal
- Total: $600/month + engineering time
...
CoreWeave approach:
- 1x H100: ~$3.00/hour = $2,190/month (estimated single-unit on-demand rate)
- Redundancy recommended: 2x H100 cluster = $4,380/month
- SLA backup support: production contract
- Operational: Minimal monitoring overhead
- Total: $4,380 + production support fees
