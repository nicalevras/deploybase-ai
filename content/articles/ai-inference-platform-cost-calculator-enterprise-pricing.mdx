...
AWS offers on-demand and reserved instance pricing. H100 instances (p5.48xlarge, 8x H100 SXM) cost approximately $98/hour on demand, or $71,540 monthly for continuous operation. Reserved instances reduce costs by roughly 50% ($49/hour, $35,770 monthly) for 1-year commitments. Note: P4d instances have A100 GPUs, not H100. See [AWS GPU pricing](/articles/aws-vs-azure-gpu-pricing) for exact rates.
