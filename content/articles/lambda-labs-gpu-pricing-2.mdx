...
Comparison: AWS reserved A100 costs $0.82/hr on a 1-year commitment (vs $1.19 on-demand). Lambda on-demand is $1.48/hr. AWS reserved looks cheap until you factor in: (1) if you don't use the full reservation, you lose money, (2) you're locked in for a year. For teams that prefer European infrastructure with similar on-demand flexibility, see [JarvisLabs GPU Pricing](/articles/jarvislabs-gpu-pricing).

For teams with variable workloads, Lambda's flexibility (pay for what you use) is worth the 20-30% premium.
