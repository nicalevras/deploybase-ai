...
- A100 40GB (a2-highgpu): $2.50-3.00 per hour depending on region
- A100 80GB (a2-ultragpu): $3.00-3.50 per hour depending on region
...
Google Cloud (on-demand): $2.50-3.50/hour
...
- Typically $3.00-3.50/hour on-demand
...
- Often $3.00-4.00/hour depending on region
