...
- **CUDA Cores:** 20,736 cores (on B200)
...
- **FP8 Performance:** 1.456 exaFLOPS per rack
...
- Without sparsity optimization: 1.456 exaFLOPS
- With sparsity: 0.364 exaFLOPS (but proportional memory savings)
...
|---|---|---|
| FP4 | 1.456 exaFLOPS | Training, ultra-low memory |
| FP8 | 1.456 exaFLOPS | Training, inference |
| BF16 | 728 petaFLOPS | Inference, mixed-precision |
| FP32 | 182 petaFLOPS | Validation, high accuracy |
