...
Compare: RunPod is $3.59/hr, Lambda is $1.99/hr, CoreWeave clusters are $50.44/hr (8xH200).
...
The NVIDIA H200 represents the latest generation of data center tensor accelerators. It features 141 GB of HBM3e memory, double the H100's capacity. This expanded memory enables larger batch sizes and longer sequence lengths in transformer models. The H200 delivers 989 teraflops of tensor float 32 performance, roughly 3.5 times the H100's throughput.
