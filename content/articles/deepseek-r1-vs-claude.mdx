...
|-------|-------|-----------|
| DeepSeek R1 | 79% | Top 2% of high school math competitors |
...
Claude is stronger on general knowledge. R1's reasoning doesn't help with factual recall. Claude's broader training wins here.
...
**Summary:** R1 wins on math and physics reasoning. Claude wins on code, general knowledge, chemistry facts. On multi-domain tasks (mixed knowledge + reasoning), the gap is <3%.
...
3. **General-purpose tasks.** Writing, summarization, analysis, research. Claude's 82% on MMLU vs R1's 78% shows stronger general knowledge.
