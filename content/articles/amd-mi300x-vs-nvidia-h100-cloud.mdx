...
- 60 TFLOPS FP32 (non-tensor); 141.1 TFLOPS TF32 (tensor core)
- 80GB HBM3 memory
...
- AMD MCDRAM and ROCm software stack
- Released Q4 2023
...
- AWS: $4.00/hour (p4d.24xlarge = 8xH100)
- Lambda: $1.48/hour (single H100)
- [RunPod](/articles/runpod-gpu-pricing): $2.50/hour (on-demand)
...
|----------|-----------|-----------|--------|
| AWS | $4.00 | $3.80 | 0.95x |
| Lambda | $1.48 | $1.30 (est) | 0.88x |
| RunPod | $2.50 | Not available | N/A |
...
MI300X and H100 have identical thermal envelopes (700W) but different power efficiency curves.

**Power Efficiency at Different Utilization:**
- 100% utilization: Both consume 700W
- 50% utilization: H100 ~400W, MI300X ~380W (MI300X slightly better)
- 25% utilization: H100 ~250W, MI300X ~220W
...
**AMD Roadmap:**
- MI325X: 288GB HBM3e (current focus)
