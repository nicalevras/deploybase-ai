...
The T4 inside g4dn instances provides 16GB GDDR6 memory and 130 TFLOPS of FP32 compute. RTX 3090 delivers 39 TFLOPS, making T4 roughly 3.3x more performant for inference-optimized workloads. For training, RTX 3090 with Tensor Cores delivers better raw throughput per card.
...
RTX 3090 delivers 39 TFLOPS FP32, comparable to A100 at 312 TFLOPS. The 8x difference means A100 trains 8x faster for large models but costs significantly more upfront and ongoing. For small models under 13 billion parameters, RTX 3090 provides acceptable training performance.
