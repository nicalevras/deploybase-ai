---
title: 'Cheapest LLM API for 2025: Cost Comparison by Model'
...
- Claude Haiku: $0.80 input / $2.40 output
- Mixtral Large: $2.00 input / $6.00 output

Claude Haiku costs 8x Mistral Small but delivers more consistent reasoning. GPT-4.1 Nano pricing (same as Mistral Small) positions it as value option in OpenAI lineup.

**Premium Tier ($2.00 - $5.00 input):**
- Claude Sonnet 4.6: $3.00 input / $15.00 output
- GPT-4.1: $2.00 input / $8.00 output
- Gemini 2.5 Pro: $1.50 input / $6.00 output
...
- OpenAI o1: $15.00 input / $60.00 output (reasoning-optimized)
- Claude Opus (legacy): $15.00 input / $75.00 output
...
| Claude Haiku | $0.0008 | $0.00096 | $0.00176 |
