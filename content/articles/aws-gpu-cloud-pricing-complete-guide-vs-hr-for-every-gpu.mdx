...
The p5.48xlarge contains 8 H100 GPUs. AWS only offers H100 as full 8-GPU instances — you cannot rent individual H100s on AWS. Per-GPU cost of ~$12.29/hr is the highest in the market, but the included 400Gbps EFA networking and 1.1TB RAM add substantial value for distributed training.

**Cost comparison:**
- AWS p5: ~$12.29/hr per H100 (full instance only)
- RunPod H100: $2.69/hr
- Vast.AI H100: $2.00-3.50/hr

AWS is 3.5-5x more expensive per GPU, but includes enterprise networking, CPU/RAM, and AWS ecosystem integration.
...
**P5 family:**
- p5.48xlarge (8x H100): ~$98/hr (only H100 instance available on-demand)
...
**p5.48xlarge Spot:**
- On-demand: $32/hr
- Spot: ~$9-15/hr (70% discount typical)
...
- On-demand: $98/hr
- Reserved (3-year): $35/hr
- Storage (8TB): $0.80/hr
- Data transfer (~100GB/month): $2/hr average
- Total: ~$38/hr reserved with overhead (~$4.75/GPU/hr)
...
Running a $98/hr instance overnight is wasteful. Stop (not terminate) when not actively computing.
...
- AWS p5: ~$12.29/hr per GPU (8-GPU instance only)
- RunPod: $2.69/hr
- Vast.AI: $2.00-3.50/hr
- Lambda: $2.49/hr (SXM) / $2.86/hr (PCIe)
