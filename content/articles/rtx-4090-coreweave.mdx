...
Performance: 362 TFLOPS (fp32) vs 4090's 260. Bandwidth: 864 GB/s vs 576 GB/s. Better for larger models.
...
Performance: 350 TFLOPS (fp32). Memory bandwidth: 576 GB/s (same as 4090, but the memory's faster).
