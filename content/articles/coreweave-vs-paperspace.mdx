...
- H100 SXM: $49.24/hour (compared to $2.69 on [RunPod](/articles/runpod-gpu-pricing))
- A100 80GB: $10.70/hour
- A40: $2.89/hour
- L40S: $1.90/hour
- RTX 6000 Ada: $1.75/hour

Wait, CoreWeave prices seem extremely high compared to RunPod. The difference: CoreWeave specializes in single-GPU and multi-GPU deployments for production use. The 8x H100 instance mentioned above is a full rack server: 8 H100s, 2TB RAM, 200TB NVMe storage. That's $49.24/hour for the full system, or $6.15/hour per-GPU in an 8-GPU configuration.

Compared to RunPod's $2.69/hour A100, CoreWeave A100 at $10.70/hour seems expensive. But CoreWeave's A100 includes more CPU, more NVMe storage, better networking, and is provisioned for production workloads. RunPod's A100 is a shared instance; CoreWeave instances are dedicated.
...
CoreWeave (A100, dedicated):
- $10.70/hour × 24 hours × 7 days = $1,797.60

Paperspace (A100):
- $0.51/hour × 24 hours × 7 days = $85.68

Paperspace is 20x cheaper for this use case. This isn't an apples-to-apples comparison (CoreWeave provides better hardware), but illustrates the cost structure: Paperspace optimizes for experimentation cost, CoreWeave optimizes for production efficiency.
