...
**CoreWeave (A100 SXM):** $1.33/hour - Aggressive pricing
...
Winner for A100: CoreWeave at $1.33/hour, with RunPod close behind and more reliable.
...
**CoreWeave:** $2.51/hour - Most competitive
**AWS (p4de.24xlarge = 8x H100 for $98.688):** $12.34/hour per H100 - Far too expensive
**Vast AI:** $2.20-2.60/hour (marketplace volatility)

Winner for H100: CoreWeave at $2.51/hour, Vast AI if developers accept marketplace volatility.
...
Winner for H200: CoreWeave at $3.32/hour.
...
**RunPod:** $5.98/hour
**Lambda Labs:** $6.08/hour
**CoreWeave:** $5.45/hour - Most competitive
**Others:** Limited availability

Winner for B200: CoreWeave at $5.45/hour.
...
- A100 on CoreWeave: $1.33/hour = $0.000369/second
- H100 on CoreWeave: $2.51/hour = $0.000697/second
- H100 delivers roughly 2.2x throughput, so per-token cost is roughly equal
...
Same on CoreWeave ($2.51/hour):
- 10 days × 24 hours × $2.51 = $602.40

Savings: $44.40 (roughly 7% cost reduction). For large teams running continuous training, CoreWeave or Vast AI savings compound significantly.
...
Bookmark [GPU pricing](/gpus) to track ongoing price changes. Providers adjust pricing monthly based on demand and cost structures. Quarterly reviews ensure developers're not overpaying relative to current market rates.
