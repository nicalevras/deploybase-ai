...
The DGX B200 includes approximately 20,736 NVIDIA CUDA cores per GPU for general compute, plus dedicated tensor cores optimized for matrix multiplication. The NVLink 5 interconnect provides 1,800 GB/s bidirectional bandwidth per GPU to neighboring GPUs in the node.
