...
Policy gradient methods (PPO, TRPO) store experience trajectories in GPU memory for batch processing. Episodic memory scales with trajectory length and environment complexity. A 10,000-step episode with 100-dimensional observation spaces fits easily. Vision-based tasks (Atari, robotics) need larger buffers. CoreWeave's [8xA100 at $21.60/hour](/gpus/coreweave) works for complex visual learning.
