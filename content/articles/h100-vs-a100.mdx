...
Memory: HBM2e (high-bandwidth memory, second-generation). Bandwidth is the same across PCIe and SXM variants: 1,935 GB/s.
...
| **Peak FP32** | 19.5 TFLOPS | 60 TFLOPS | H100 (3x) |
...
| **Price/GPU-hr** | $1.19-$1.39 | $2.49-$2.86 | A100 (cheaper) |
