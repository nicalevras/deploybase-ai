...
[Mistral Large](/articles/mistral-large-pricing-compare-costs-across-all-api) costs approximately $2/$6 per million tokens. This pricing reflects Mistral's different model architecture. Direct capability comparison shows nuanced differences by task type.
