...
Reserved capacity: $0.25-$0.60 per million tokens depending on model and volume. Better than pay-as-you-go but requires forecasting and upfront commitment.

Example: Processing 500M tokens/month of Llama 2 70B.

- **Pay-as-you-go:** 500M × $1.50 = $750
...
**Variable Workloads:** Unpredictable volume. Reserved capacity requires forecasting. Pay-as-you-go pricing at $1.50/M is competitive but not the cheapest. Better to use OpenAI API for variable load (pay only for what you use).
