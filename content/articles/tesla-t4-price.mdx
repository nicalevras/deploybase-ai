...
**Compute Cores:** 7,424 CUDA cores (vs T4's 2,560)
**Tensor Performance:** 242 TFLOPS (TF32, with sparsity) vs T4's 130 TOPS INT8
**Memory Bandwidth:** 300 GB/s (vs T4's 320 GB/s)
