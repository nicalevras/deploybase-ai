...
Billing works differently than reserved. RunPod on-demand H100 SXM costs $2.49/hour. RunPod Serverless: $0.25 per execution plus $0.00024 per GPU second. A 100-second inference (model load + 10 requests of 10 seconds) runs $0.25 + (100 × $0.00024) = $0.274.
...
Using equivalent reserved H100 ($2.49/hour):
- Cost per inference: $2.49 / 3600 * 20 = $0.0138
