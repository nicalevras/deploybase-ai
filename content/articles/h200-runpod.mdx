---
title: 'H200 RunPod: 141GB HBM3, Large Model Inference, and Cost Analysis'
slug: h200-runpod
description: >-
  H200 RunPod costs $3.59/hr with 141GB HBM3. Master large model inference,
...
H200 runpod is $3.59/hr with 141GB HBM3 memory. That's 1.76x H100's 80GB. Good for 70B+ models where H100 forces quantization or distributed serving.

Memory bandwidth is 4.8 TB/s (45% more than H100). That matters for token generation latency.
...
|---|---|---|
| GPU Memory | 141GB HBM3 | 80GB HBM3 |
| Memory Bandwidth | 4.8 TB/s | 3.3 TB/s |
| Compute Cores | 16,896 | 16,896 |
| Peak FP32 | 989 TFLOPS | 989 TFLOPS |
| PCIe Bus Bandwidth | 144 GB/s | 108 GB/s |
| L2 Cache | 50MB | 50MB |

The H200's primary differentiator is memory capacity: 1.76x more HBM3 than H100. Memory bandwidth also increases 45%, critical for large batch inference.
